...
const SimpleFallback = () => (
  <div className="flex h-full w-full flex-col items-center justify-center bg-gradient-to-br from-black to-blue-950 p-8">
    <div className="mb-8 text-center">
      ...
      <h2 className="mb-2 text-2xl font-bold text-white">SuperDocs</h2>
      <p className="text-blue-200">
        Advanced document processing with intelligent insights
      </p>
    </div>
...
const AIKnowledgeSystem = dynamic(
  () => import("@/components/auth/3D/AIKnowledgeSystem"),
  {
    ssr: false,
  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
      ...
      <div className="relative hidden h-full overflow-hidden bg-black lg:block">
        {isMounted && (can3D ? <AIKnowledgeSystem /> : <SimpleFallback />)}
      </div>
    </div>
  );
}
